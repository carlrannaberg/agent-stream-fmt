...
export type MessageEvent = { t: 'msg'; role: 'user' | 'assistant' | 'system'; text: string; timestamp?: number };
export type ToolEvent = { t: 'tool'; name: string; phase: 'start' | 'stdout' | 'stderr' | 'end'; text?: string; exitCode?: number };

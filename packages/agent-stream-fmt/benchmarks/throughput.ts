...
async function runBenchmark() {
  ...
  console.log(`Starting throughput benchmark with ${lines.toLocaleString()} lines...`);
  // eslint-disable-next-line no-console
  console.log(`Total data size: ${(data.length / 1024 / 1024).toFixed(2)} MB\n`);
  ...
  try {
    ...
    console.log('==================');
    // eslint-disable-next-line no-console
    console.log(`Processed: ${count.toLocaleString()} events from ${lines.toLocaleString()} lines`);
    // eslint-disable-next-line no-console
    console.log(`Time: ${elapsedMs.toFixed(2)} ms (${elapsedSec.toFixed(2)} seconds)`);
    // eslint-disable-next-line no-console
    console.log(`Throughput: ${linesPerSec.toFixed(0).toLocaleString()} lines/sec`);
    // eslint-disable-next-line no-console
    console.log(`Memory RSS: ${(finalMemory / 1024 / 1024).toFixed(2)} MB`);
    // eslint-disable-next-line no-console
    console.log(`Memory Delta: ${memoryUsed > 0 ? '+' : ''}${memoryUsed.toFixed(2)} MB`);
    // eslint-disable-next-line no-console

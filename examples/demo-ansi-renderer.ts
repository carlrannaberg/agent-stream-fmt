...
async function demoBasicRendering() {
  ...
  const events: AgentEvent[] = [
    ...
    { t: 'msg', role: 'assistant', text: 'Of course! I\'ll help you install a package. Let me run `npm install` for you.' },
    { t: 'tool', name: 'npm', phase: 'start', text: 'install express' },
    { t: 'tool', name: 'npm', phase: 'stdout', text: 'added 58 packages, and audited 59 packages in 2s' },
    { t: 'tool', name: 'npm', phase: 'stdout', text: '8 packages are looking for funding\n  run `npm fund` for details' },
    { t: 'tool', name: 'npm', phase: 'stdout', text: 'found 0 vulnerabilities' },
    { t: 'tool', name: 'npm', phase: 'end', exitCode: 0 },
    { t: 'msg', role: 'assistant', text: 'Great! I\'ve successfully installed Express for you.' },
...
async function demoCollapsedTools() {
  ...
  const events: AgentEvent[] = [
    ...
    { t: 'tool', name: 'webpack', phase: 'stdout', text: 'Hash: 1a2b3c4d5e6f\nVersion: webpack 5.89.0\nTime: 1234ms\nBuilt at: 12/07/2024 10:00:00 AM' },
    { t: 'tool', name: 'webpack', phase: 'stdout', text: 'asset main.js 123 KiB [emitted] (name: main)\nasset styles.css 45 KiB [emitted]' },
    { t: 'tool', name: 'webpack', phase: 'stdout', text: 'Entrypoint main 168 KiB = main.js 123 KiB styles.css 45 KiB\nwebpack compiled successfully' },
...
async function demoErrorHandling() {
  ...
  const events: AgentEvent[] = [
    ...
    { t: 'tool', name: 'cat', phase: 'stderr', text: 'cat: /etc/shadow: Permission denied' },
    { t: 'tool', name: 'cat', phase: 'end', exitCode: 1 },
    { t: 'error', message: 'Failed to read file: Permission denied' },
    { t: 'debug', raw: { error: 'EACCES', syscall: 'open', path: '/etc/shadow' } }
  ];
...
async function demoAllRoles() {
  ...
  const events: AgentEvent[] = [
    ...
    { t: 'msg', role: 'assistant', text: 'Hi there! How can I help you today?' }
  ];
...
async function main() {
  ...
  console.log('Watch how different event types are rendered with colors and formatting!\n');
